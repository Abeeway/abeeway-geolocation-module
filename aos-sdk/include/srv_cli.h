...
/*!
 * \def CLI_ACCESS_FROM_USER_LEVEL
 *
 * \brief Macro helper to be used for a command requiring the super user credential.
 */
#define CLI_ACCESS_FROM_USER_LEVEL (cli_access_mask_user | cli_access_mask_super)
...
/*!
 *
 * \fn aos_result_t srv_cli_init(aos_uart_type_t uart_type, cli_config_param_t* config)
 *
 ...
 */
aos_result_t srv_cli_init(aos_uart_type_t uart_type, cli_config_param_t* config);
