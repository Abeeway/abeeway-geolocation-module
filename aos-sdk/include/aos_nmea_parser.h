...
/*!
 * \typedef nmea_parsing_res_t (*nmea_parsing_cb_t)(nmea_parse_msg_t* info, nmea_parsing_cb_param_t* param)
 *
...
/*!
 * \fn aos_result_t nmea_open(aos_gnss_callback_t cb_fn, void *cb_arg, uint8_t *msgbuf, uint16_t msgbuf_len, const nmea_dictionary_t* vendor_dict);
 *
...
/*!
 * \fn aos_result_t nmea_set_constellation(aos_gnss_cfg_constellation_t constellation)
 *
 * \brief Set the constellation usable by the GNSS driver
 *
 * \param constellation Usable constellation
 *
 * \return Success or failure
 */
aos_result_t nmea_set_constellation(aos_gnss_cfg_constellation_t constellation);
