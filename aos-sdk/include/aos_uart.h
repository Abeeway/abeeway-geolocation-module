...
/*!
 * \fn void (*aos_uart_rx_callback_t)(void* user_arg)
 *
 ...
 */
/*!
 * \fn aos_result_t (*aos_uart_open_t)(aos_uart_type_t type, aos_uart_config_t* config)
 *
 * \brief Open an UART driver
 *
...
/*!
 * \fn aos_result_t (*aos_uart_close_t)(aos_uart_type_t type)
 *
...
/*!
 * \fn aos_result_t (*aos_uart_read_t)(aos_uart_type_t type, uint8_t* data, uint16_t* length);
 *
 * \brief Read received bytes from the UART
 *
 * \param type UART type
...
/*!
 * \fn aos_result_t (*aos_uart_write_t)(aos_uart_type_t type, const uint8_t* data, uint16_t* length)
 *
 * \brief Send bytes over the UART
 *
 * \param type UART type
...
/*!
 * \fn aos_result_t (*aos_uart_ioctl_t)(aos_uart_type_t type, aos_uart_ioctl_info_t* info)
 *
