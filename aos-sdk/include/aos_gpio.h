 ...
 */
typedef enum {
	aos_gpio_id_vbat_sense = 0,		//!< VBAT_SENSE module PIN
...
typedef enum {
	...
	aos_gpio_mode_alternate,			//!< GPIO alternate function
 ...
 */
typedef enum {
	aos_gpio_irq_priority_very_low,		//!< Very low priority  (0)
...
/*!
 * \fn void aos_gpio_bat_setup(aos_gpio_id_t gpio_vbat_ctrl, aos_gpio_id_t gpio_vbat_analog,
 ...
 *
 * \param gpio_vbat_ctrl Battery monitoring. Voltage bridge control. If no voltage divider bridge,
 *  	pass aos_gpio_id_last.
