...
, the GNSS device must be enabled with the CLI command `gnss mt3333 on` as shown in *Figure 9* and supplied as shown in *Figure 1* (pin 30: VDD_GNSS and pin 32: VDD_GNSS_BU set to 3.3V -- Jumpers 2,4,15). 
